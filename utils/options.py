...
def args_parser():
    ...
    parser.add_argument("--beta", type=float, default=1, help="Average moving parameter")
    parser.add_argument("--L_k", type=float, default=100, help="Regularization term")
    ...
    parser.add_argument("--algorithm", type=str, default="FedAvg",choices=["FedAvg","FedRob"]) 
