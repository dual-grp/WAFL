...
def args_parser():
    ...
    parser.add_argument("--robust", type=float, default=0.25, help="robust training and faction of attack client, 0 mean no attack and no robust")
    ...
    parser.add_argument("--algorithm", type=str, default="FedAvg",choices=["FedRob","FedAvg","FedAvgAT"]) 
