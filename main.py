...
def main(experiment, dataset, algorithm, batch_size, learning_rate, robust, gamma, num_glob_iters, local_epochs, sub_user, numusers, K, alpha, times, commet, gpu, epsilon):
    ...
    for i in range(times):
        ...
        if(algorithm == "FedAvg"):
            ...
            if(commet):
                experiment.set_name(dataset[0] + "_" + algorithm + "_" + model[1] + "_" + str(batch_size) + "_" + str(learning_rate) + "_" + str(num_glob_iters) + "_"+ str(local_epochs) + "_"+ str(numusers))
            server = WAFL(experiment, device, domain_data, algorithm, model, batch_size, learning_rate, robust, gamma, num_glob_iters, local_epochs, sub_user, numusers, K, alpha, i, epsilon)
